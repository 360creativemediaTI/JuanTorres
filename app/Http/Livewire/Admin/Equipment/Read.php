...
class Read extends Component
{
    ...
    protected $listeners = ['equipmentDeleted'];
    ...
    public function render()
    {
        ...
        $instance = getCrudConfig('equipment');
        ...
        return view('livewire.admin.equipment.read', [
            'equipments' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Equipment')) ]);
    }
}
